function SHA256(s: string):string{
	...
	function core_sha256 (m: Array<any>, l: number) {
			...
			let HASH = new Array(0x6A09E667, 0xBB67AE85, 0x3C6EF372, 0xA54FF53A, 0x510E527F, 
	...
	function str2binb (str: string): Array<any> {
			let bin = Array();
			let mask = (1 << chrsz) - 1;
	...
	function binb2hex (binarray: Array<any>): string {
